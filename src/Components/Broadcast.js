...
// import '@millicast/sdk'; // Import Millicast SDK
...
//   useEffect(() => {
//     // Initialize the Millicast SDK and create a publisher instance
...
//         const publisherInstance = new millicast.Publish(yourStreamName, tokenGenerator);
...
//     // Cleanup function to stop the publisher and release media stream when component unmounts
//     return () => {
//       if (publisher) {
//         publisher.stop();
//       }
...
//                 }}
//               >
//                 <i className="bi bi-pause-circle-fill"></i> Pause Stream
//               </button>
//             </div>
//           </div>
